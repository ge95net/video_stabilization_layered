...
class OmnimatteModel(BaseModel):
    ...
    def forward(self):
        ...
        self.target_image = self.rearrange2batchdim(self.target_image) #将t，t+1从channel上转移到batch上
        ...
        layers[:, -1, 0] = 1  # Background layer's alpha is always 1 (-1 --> alpha, 0 --> background)
